...
namespace Util.Controls
{
    ...
    public class AnimatedGIF : Image
    {
        ...
        /// 是否启用动画
        /// </summary>
        public bool AnimatioinEnable
        {
            get { return (bool)GetValue(AnimatioinEnableProperty); }
            set { SetValue(AnimatioinEnableProperty, value); }
        }
        public static readonly DependencyProperty AnimatioinEnableProperty =
            DependencyProperty.Register("AnimatioinEnable", typeof(bool), typeof(AnimatedGIF), new PropertyMetadata(true, OnAnimatioinEnableChanged));
        ...
        private static void OnAnimatioinEnableChanged(DependencyObject sender, DependencyPropertyChangedEventArgs args)
        {
            ...
            if (gif == null) return;
            if (!gif.IsLoaded) return;
            if (gif.AnimatioinEnable) gif.StartAnimate();
            else gif.StopAnimate();
        }
        ...
        private static BitmapSource GetBitmapSource(Bitmap bmap, BitmapSource bimg)
        {
            ...
            try
            {
                ...
                bimg = Imaging.CreateBitmapSourceFromHBitmap(handle, IntPtr.Zero, Int32Rect.Empty, BitmapSizeOptions.FromEmptyOptions());
            }
            finally
            {
